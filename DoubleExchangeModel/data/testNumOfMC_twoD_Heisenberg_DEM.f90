...
program double_exchange
    ...
    !##########################################
    integer, parameter :: L = 4, N = 16, M = 32, num_MC = 10**6
    real*8, parameter :: t = 1.0, PI = 3.141592654
    integer :: i, j, k, p, d, di, dd
    ...
    call initran(1)
    open(unit=12, file='T-En.dat')
    open(unit=15,file='T-EN_all.dat')
    open(unit=14,file='T-S_test.dat')
    open(unit=13,file='All_ss.dat')
    ...
    do i = 1, num_MC 
        ...
        !write(*,*) ln_Weight, ln_Weight_new_theta, i
        !write(*,*) 'theta=', theta(i,:)
        ...
        !write(*,*) d
        d = dd
        write(13,*) i, ss(i), s_M(i)
        write(15,*) i, En(i)
    end do
    do i = 1, 10000
        write(14,*) i, ss(num_MC-10000+i), s_M(num_MC-10000+i)
        write(12,*) i, En(num_MC-10000+i)
    end do
    write(*,*) 'end'
